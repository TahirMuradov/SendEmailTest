...
email.From.Add(new MailboxAddress("Muradov Tahir", "muradovtahir01@gmail.com"));//kimden 
email.To.Add(new MailboxAddress("Muradov Tahir", "muradovtahir01@gmail.com"));//kime
...
using (var smtp = new SmtpClient())
    {
        ...
        await smtp.ConnectAsync("smtp-mail.outlook.com", Convert.ToInt32(587), MailKit.Security.SecureSocketOptions.StartTls);
        await smtp.AuthenticateAsync("muradovtahir01@gmail.com", "4575865t");//mail gonderen emailin sifre parolu
